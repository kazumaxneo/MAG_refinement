...
MAG sequences derived from short reads consist of a set of fragmented contigs that are cutted in hundreds of position.   
Gene prediction is severely affected by such fragmented draft genomes. This script aims to improve MAG contiguity by   
reassembling bin using a pair of properly mapped HiFi long reads and short reads. 
